...
public class PermissionService {
    ...
    public void delete(long id) {
        ...
        Permission cPermission = perOptional.get();
        cPermission.getRoles().forEach(role -> role.getPermissions().remove(cPermission));

        this.permissionRepository.delete(cPermission);
    }
